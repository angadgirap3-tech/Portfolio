...
| Rule | Standard | Avoid |
|------|----------|--------|
| **No Emoji as Icons** | Use SVG icons (Lucide, Heroicons, etc.) | Using emojis (🎨 🚀 ⚙️) for navigation or system controls |
...
| **Stroke Consistency** | Consistent stroke width (e.g. 1.5px or 2px) | Mixing thick and thin stroke styles arbitrarily |
| **Filled vs Outline Discipline** | One icon style per hierarchy level | Mixing filled and outline icons at the same level |
| **Touch Target Minimum** | Min 44×44pt interactive area | Small icons without expanded tap area |
| **Icon Contrast** | 4.5:1 for small elements, 3:1 minimum for larger UI glyphs | Low-contrast icons that blend into the background |

### Layout & Spacing

| Rule | Do | Don't |
|------|----|----- |
| **Safe-area compliance** | Respect top/bottom safe areas for fixed headers, tab bars, CTAs | Placing fixed UI under notch or status bar |
| **8dp spacing rhythm** | Consistent 4/8dp spacing system | Random spacing increments with no rhythm |
| **Readable text measure** | Keep long-form text readable (avoid edge-to-edge on large screens) | Full-width long text paragraphs on tablets |
| **Scroll and fixed element coexistence** | Add content insets so lists aren't hidden behind fixed bars | Scroll content obscured by sticky headers/footers |
